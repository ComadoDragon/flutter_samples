...
class _MenuDashboardState extends State<MenuDashboard>
  ...
  double displayHeigth, displayWidth;
  ...
  Widget build(BuildContext context) {
    displayHeigth = MediaQuery.of(context).size.height;
  ...
  Widget menuCreated(BuildContext context) {
  ...
  Widget dashBoardCreated(BuildContext context) {
    return AnimatedPositioned(
      duration: _duration,
      top: 0,
      bottom: 0,
      left: isMenuOpen ? 0.4 * displayWidth : 0,
      right: isMenuOpen ? -0.4 * displayWidth : 0,
      child: ScaleTransition(
        scale: _scaleAnimation,
        child: Material(
          borderRadius:
          isMenuOpen ? BorderRadius.all(Radius.circular(40)) : null,
          elevation: 8,
                  ...
                  ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          title: Text("Student $index", style: menuFontStyle),
                          trailing: Icon(
                            Icons.add,
                            color: Colors.purple,
                          ),
